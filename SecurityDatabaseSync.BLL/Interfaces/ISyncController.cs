...
namespace SecurityDatabaseSync.BLL.Interfaces
{
    ...
    public interface ISyncController
    {
        ...
        Task<bool> InsertDataAsync(string databaseName, string identifier);

        /// <summary>
        /// Удалить данные из конкретной базы данных.
        /// </summary>
        /// <param name="databaseName">название базы данных.</param>
        Task<bool> ClearDataAsync(string databaseName);
        ...
        /// <param name="databaseName">название базы данных.</param>
        /// <param name="identifier">условие выборки (идентификатор).</param>
        Task<bool> ClearDataAsync(string databaseName, string identifier);
        ...
        /// <param name="identifier">условие выборки (идентификатор).</param>
        Task<bool> CopyDataAsync(string dbFirst, string dbSecond, string identifier);
    }
}
